...
Removing `models/optimized/` causes the graphs to be rebuilt on subsequent use.
`--no-cache` bypasses the SQLite index, while model artifacts and optimized graphs remain cached.
